...
## Serve data to machine learning workflows
...
- choose between different types of compute that can handle large data transformations at scale: serverless SQL pools, dedicated SQL pools, or Spark pools.

### Azure Databricks

Azure Databricks allows you to define your pipelines in a notebook, which you can schedule to run. uses Spark clusters

### Azure Machine Learning

<u>Whenever you want to perform all tasks within the same tool, creating and scheduling an Azure Machine Learning pipeline to run with the on-demand compute cluster may best suit your needs.</u>
